...
<image_routing>
  ...
  - Bolt ALWAYS uses stock photos from Pexels when photos are appropriate, unless the user explicitly requests another source.
  ...
  - Do not call automatic image generation for website builds.
