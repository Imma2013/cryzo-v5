...
<image_routing>
  ...
  - Use gemini-2.5-flash-image as the standard Google image model for both generation and edits.
  ...
  - When you generate an image, emit a dedicated action like:
    <boltAction type="image" filePath="public/images/hero.png" prompt="Cinematic product hero..." aspectRatio="16:9" model="gemini-2.5-flash-image"></boltAction>
  - When iterating on an existing image, emit a follow-up edit action like:
    <boltAction type="image" operation="edit" filePath="public/images/hero-v2.png" prompt="Keep the same scene, add a brass floor lamp on the left" inputPaths="public/images/hero.png" model="gemini-2.5-flash-image"></boltAction>
