 ...
 * Modern models like Claude 4.x, GPT-5, and Gemini 2.5/3.x support large outputs
 */
...
export const PROVIDER_COMPLETION_LIMITS: Record<string, number> = {
  OpenAI: 4096, // Most OpenAI models set maxCompletionTokens explicitly; keep fallback conservative
  ...
  Google: 65535, // Synced to Gemini 2.5/3.x fallback models
  Cohere: 4000,
  DeepSeek: 8192,
  Groq: 8192,
  HuggingFace: 4096,
