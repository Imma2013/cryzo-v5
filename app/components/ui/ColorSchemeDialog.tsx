...
export const ColorSchemeDialog: React.FC<ColorSchemeDialogProps> = ({ setDesignScheme, designScheme }) => {
  ...
  return (
    <div>
      <IconButton title="Design Overrides" className="transition-all" onClick={() => setIsDialogOpen(!isDialogOpen)}>
          ...
          <div className="py-4 px-4 min-w-[480px] max-w-[90vw] max-h-[85vh] flex flex-col gap-6 overflow-hidden">
            <div className="">
              ...
              <DialogDescription className="text-bolt-elements-textSecondary leading-relaxed">
                Customize optional palette, typography, and feature overrides. The shared
                `vendor/awesome-design-md/design-md` library is the primary design reference when compatible.
              </DialogDescription>
            </div>
