            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className={classNames(
                  ...
                  activeView === 'apps'
                    ? 'bg-purple-600 dark:bg-purple-500 text-white border-purple-700 dark:border-purple-600'
                ...
                aria-label={activeView === 'apps' ? 'Return to chats' : 'Open apps'}
              >
                <span className="i-ph:grid-nine h-4 w-4" />
