...
## Identity
Expo should be treated as a category-correct reference system for developer, mobile, using technical, friendly as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around technical, friendly composition logic native to Expo, not a generic marketing template.
...
## Core Visual Rules
- Keep the composition faithful to developer, mobile expectations.
- Let technical, friendly shape typography, spacing, surfaces, and motion.
- Make the result feel native to developer-tools rather than generic premium marketing.
...
- Style keywords: technical, friendly
