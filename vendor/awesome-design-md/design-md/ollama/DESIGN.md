...
## Identity
Ollama should be treated as a category-correct reference system for ai, developer, using technical, minimal as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around technical, minimal composition logic native to Ollama, not a generic marketing template.
