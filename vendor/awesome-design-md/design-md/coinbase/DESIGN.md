...
## Identity
Coinbase should be treated as a category-correct reference system for crypto-exchange, using trustworthy, premium as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around trustworthy, premium composition logic native to Coinbase, not a generic marketing template.
...
## Core Visual Rules
- Keep the composition faithful to consumer, crypto, fintech expectations.
- Let trustworthy, premium shape typography, spacing, surfaces, and motion.
- Make the result feel native to crypto, fintech, commerce rather than generic premium marketing.
...
- Product types: crypto-exchange
- Style keywords: trustworthy, premium
...
- Revolut can be referenced only for minor supporting polish, never as an overpowering second primary.
