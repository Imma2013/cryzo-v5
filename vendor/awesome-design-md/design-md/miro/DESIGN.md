...
## Identity
Miro should be treated as a category-correct reference system for collaboration, productivity, using friendly, playful as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around friendly, playful composition logic native to Miro, not a generic marketing template.
...
## Core Visual Rules
- Keep the composition faithful to collaboration, productivity expectations.
- Let friendly, playful shape typography, spacing, surfaces, and motion.
- Make the result feel native to collaboration, productivity rather than generic premium marketing.
...
- Style keywords: friendly, playful
