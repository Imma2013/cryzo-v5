...
## Identity
Replicate should be treated as a category-correct reference system for ai, developer, using technical as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around technical composition logic native to Replicate, not a generic marketing template.
