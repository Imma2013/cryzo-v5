...
## Identity
Mistral AI should be treated as a category-correct reference system for ai-lab, using technical, futuristic as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around technical, futuristic composition logic native to Mistral AI, not a generic marketing template.
...
## Core Visual Rules
- Keep the composition faithful to ai expectations.
- Let technical, futuristic shape typography, spacing, surfaces, and motion.
- Make the result feel native to ai, research rather than generic premium marketing.
...
- Cohere can be referenced only for minor supporting polish, never as an overpowering second primary.
