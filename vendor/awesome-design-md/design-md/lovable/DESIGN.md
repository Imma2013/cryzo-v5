...
## Identity
Lovable should be treated as a category-correct reference system for website-builder, using playful, premium as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around playful, premium composition logic native to Lovable, not a generic marketing template.
...
## Core Visual Rules
- Keep the composition faithful to ai, creative, website-builder expectations.
- Let playful, premium shape typography, spacing, surfaces, and motion.
- Make the result feel native to ai, website-builder rather than generic premium marketing.
...
- Style keywords: playful, premium
