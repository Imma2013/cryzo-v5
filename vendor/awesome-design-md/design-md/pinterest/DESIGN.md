...
## Identity
Pinterest should be treated as a category-correct reference system for consumer, creative, using playful, editorial as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around playful, editorial composition logic native to Pinterest, not a generic marketing template.
...
## Core Visual Rules
- Keep the composition faithful to consumer, creative expectations.
- Let playful, editorial shape typography, spacing, surfaces, and motion.
- Make the result feel native to consumer, design rather than generic premium marketing.
...
- Style keywords: playful, editorial
