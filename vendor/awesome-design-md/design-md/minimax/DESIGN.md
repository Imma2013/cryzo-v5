...
## Identity
Minimax should be treated as a category-correct reference system for ai, media, using futuristic, premium as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around futuristic, premium composition logic native to Minimax, not a generic marketing template.
...
- Let futuristic, premium shape typography, spacing, surfaces, and motion.
- Make the result feel native to ai, media rather than generic premium marketing.
...
- Style keywords: futuristic, premium
