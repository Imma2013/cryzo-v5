...
## Identity
Mongodb should be treated as a category-correct reference system for database-platform, using technical as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around technical composition logic native to Mongodb, not a generic marketing template.
...
## Core Visual Rules
- Keep the composition faithful to database, developer, enterprise expectations.
- Let technical shape typography, spacing, surfaces, and motion.
- Make the result feel native to developer-infra, database rather than generic premium marketing.
