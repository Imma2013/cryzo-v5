...
## Identity
Ibm should be treated as a category-correct reference system for enterprise, using trustworthy, technical as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around trustworthy, technical composition logic native to Ibm, not a generic marketing template.
...
## Core Visual Rules
- Keep the composition faithful to enterprise expectations.
- Let trustworthy, technical shape typography, spacing, surfaces, and motion.
- Make the result feel native to enterprise rather than generic premium marketing.
