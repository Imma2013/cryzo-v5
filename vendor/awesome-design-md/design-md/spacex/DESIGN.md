...
## Identity
Spacex should be treated as a category-correct reference system for space, using cinematic, technical as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around cinematic, technical composition logic native to Spacex, not a generic marketing template.
...
## Core Visual Rules
- Keep the composition faithful to space expectations.
- Let cinematic, technical shape typography, spacing, surfaces, and motion.
- Make the result feel native to space rather than generic premium marketing.
...
- Style keywords: cinematic, technical
