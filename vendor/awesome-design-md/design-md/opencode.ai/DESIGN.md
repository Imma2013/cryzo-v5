...
## Identity
OpenCode AI should be treated as a category-correct reference system for ai-coding-tool, using technical, premium as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around technical, premium composition logic native to OpenCode AI, not a generic marketing template.
...
- Make the result feel native to ai, developer-tools rather than generic premium marketing.
