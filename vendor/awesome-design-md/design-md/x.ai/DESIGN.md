...
## Identity
xAI should be treated as a category-correct reference system for ai-lab, using technical, futuristic as the guiding visual attitude.
...
- model company
- frontier ai lab
- research-heavy ai brand
- ai
- research

## Signature Markers
- Layout DNA: build around technical, futuristic composition logic native to xAI, not a generic marketing template.
