...
## Identity
Revolut should be treated as a category-correct reference system for banking-app, using premium, trustworthy as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around premium, trustworthy composition logic native to Revolut, not a generic marketing template.
...
## Core Visual Rules
- Keep the composition faithful to consumer, fintech expectations.
- Let premium, trustworthy shape typography, spacing, surfaces, and motion.
- Make the result feel native to fintech, commerce rather than generic premium marketing.
...
- Product types: banking-app
- Style keywords: premium, trustworthy
...
- Wise can be referenced only for minor supporting polish, never as an overpowering second primary.
