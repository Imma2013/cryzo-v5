...
## Identity
Elevenlabs should be treated as a category-correct reference system for voice-ai, using premium, technical as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around premium, technical composition logic native to Elevenlabs, not a generic marketing template.
...
## Core Visual Rules
- Keep the composition faithful to ai, media expectations.
