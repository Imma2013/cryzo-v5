...
## Identity
Bmw should be treated as a category-correct reference system for car-commerce, using premium, technical as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around premium, technical composition logic native to Bmw, not a generic marketing template.
- Scale behavior: Keep scale controlled and deliberate so one product frame or one precise headline leads the page.
- Palette dominance: Palette dominance should clearly follow the selected reference category rather than a default purple-on-dark fallback.
- Type tension: Typography should feel exact and restrained, with minimal decorative flourish.
- Imagery treatment: Imagery should be vehicle-led, cropped with intent, and treated as the page’s emotional anchor instead of a supporting thumbnail.
...
## Core Visual Rules
- Keep the composition faithful to automotive, consumer, luxury expectations.
- Let premium, technical shape typography, spacing, surfaces, and motion.
- Make the result feel native to automotive, commerce rather than generic premium marketing.
...
- Product types: car-commerce
- Style keywords: premium, technical

## Capabilities
- Supports severe restraint and minimal product-showcase framing.

## Compatible Support Systems
- Tesla can be referenced only for minor supporting polish, never as an overpowering second primary.
