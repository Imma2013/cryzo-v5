...
## Identity
Nvidia should be treated as a category-correct reference system for ai, developer, hardware, using technical, futuristic as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around technical, futuristic composition logic native to Nvidia, not a generic marketing template.
...
- Imagery treatment: Imagery should center the product object and make the hardware feel tangible, premium, and hero-worthy.
...
## Core Visual Rules
- Keep the composition faithful to ai, developer, hardware expectations.
- Let technical, futuristic shape typography, spacing, surfaces, and motion.
- Make the result feel native to consumer-hardware, ai, developer-tools rather than generic premium marketing.
...
- Style keywords: technical, futuristic

## Capabilities
- No special capability flags are defined beyond the standard reference behavior.

## Compatible Support Systems
- Cryzo 2 can be referenced only for minor supporting polish, never as an overpowering second primary.
