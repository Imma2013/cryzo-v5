...
## Identity
Posthog should be treated as a category-correct reference system for data, developer, using technical as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around technical composition logic native to Posthog, not a generic marketing template.
...
## Core Visual Rules
- Keep the composition faithful to data, developer expectations.
- Let technical shape typography, spacing, surfaces, and motion.
- Make the result feel native to analytics, developer-tools rather than generic premium marketing.
