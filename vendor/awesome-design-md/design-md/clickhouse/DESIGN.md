...
## Identity
Clickhouse should be treated as a category-correct reference system for database-platform, using technical, trustworthy as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around technical, trustworthy composition logic native to Clickhouse, not a generic marketing template.
...
## Core Visual Rules
- Keep the composition faithful to data, database, developer, enterprise expectations.
- Let technical, trustworthy shape typography, spacing, surfaces, and motion.
- Make the result feel native to database, analytics, developer-infra rather than generic premium marketing.
...
- Product types: database-platform
- Style keywords: technical, trustworthy

## Capabilities
- No special capability flags are defined beyond the standard reference behavior.

## Compatible Support Systems
- Mongodb can be referenced only for minor supporting polish, never as an overpowering second primary.
- Supabase can be referenced only for minor supporting polish, never as an overpowering second primary.
- Sentry can be referenced only for minor supporting polish, never as an overpowering second primary.
