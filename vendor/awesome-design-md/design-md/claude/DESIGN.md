...
## Identity
Claude should be treated as a category-correct reference system for ai-lab, using minimal, trustworthy as the guiding visual attitude.
...
## Signature Markers
- Layout DNA: build around minimal, trustworthy composition logic native to Claude, not a generic marketing template.
...
- Let minimal, trustworthy shape typography, spacing, surfaces, and motion.
...
- Style keywords: minimal, trustworthy
